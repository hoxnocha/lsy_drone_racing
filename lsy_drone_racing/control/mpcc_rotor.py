...
class MPCC(Controller):
    ...
    def _build_ocp_and_solver(
        ...
        # --------- 权重设置（可以再微调） ----------
        self.q_l = 591.5960500016809 #618.9542229287326 #522.327621281147 #200 
        self.q_c = 377.45736804790795 #351.2429403141141 #279.45878291502595 #100 
        self.Q_w = 1 * DM(np.eye(3))

        # 门附近：贴轨更硬
        self.q_l_gate_peak = 862.2289886698127 #693.8557932153344 #520.2687042765319 #640
        self.q_c_gate_peak = 999.8831287026405 #736.6428766399622 #764.3037075176835 #800

        # 障碍物附近：贴轨也加强，但稍微弱一点
        self.q_l_obst_peak = 283.36755665950477 #217.8564189467579 #207.83845749683678 #100 
        self.q_c_obst_peak = 97.46472304686904 #144.14965459145606 #110.51885732449591 #50 

        self.R_df = DM(np.diag([0.1, 0.5, 0.5, 0.5]))

        # 进度项基础奖励
        self.miu = 12.277817506343126 #13.789033382199705 #14.3377785384655#6.613274002447724 
        # 门减速强一点
        self.w_v_gate = 2.299716074485332 #3.5892128823325042 #2.7327203765511516#2.5
        # 障碍物减速弱一点
        self.w_v_obst = 0.5387065223418176 #2.5812407329678537 #2.460291111562401 #0.5 
